...
@section('content')
    <div class="page-header">
        <h3 class="fw-bold mb-3">Category Manage</h3>
    ...
    <script>
        $(document).ready(function() {
                ...
                "columns": [
                    ...
                    {"data": "Description"},
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            var id = parseInt(data.CategoryID);
            ...
            $('#order-details-datatables tbody').on('click', 'button.status-button', function() {
                ...
                let url = '/manage_category_status';
                ...
                <div class="modal-body">
                    <form id="categoryForm"  enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" id="saveCategoryBtn" style="width:100%;">Save
                                changes
                            </button>
                        </div>
                    </form>
...
{{--this script use for submit form data--}}
    <script>
        $('#categoryForm').on('submit',function (event){
            ...
            const categoryImage = document.getElementById('picture').files[0];
            if (categoryImage) {
                formData.append('picture', categoryImage);
            }
            $.ajax({
                url: '/category_manage', // Change this to your actual endpoint
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': csrfToken
                },
