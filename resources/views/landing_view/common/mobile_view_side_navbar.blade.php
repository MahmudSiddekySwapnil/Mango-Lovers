...
{{--                            <h3 class="view-name"><a id="product-name" href="#">existing product name</a></h3>--}}
{{--                            <div class="view-meta">--}}
{{--                                <p>SKU: <span id="product-sku">1234567</span></p>--}}
{{--                                <p>BRAND: <a id="product-brand" href="#">radhuni</a></p>--}}
{{--                            </div>--}}
...
{{--                                <span id="product-price">$24.00<small>/per kilo</small></span>--}}
{{--                            </h3>--}}
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="view-details">
                            ...
                            <div class="product-action" style="display:inline-flex">
                                <button class="action-minus a-minus" title="Quantity Minus"><i
                                        class="icofont-minus"></i></button>
                                <input class="action-input" title="Quantity Number" type="text" name="quantity"
                                       id="quantity-input" value="1" min="1">
                                <button class="action-plus a-plus" title="Quantity Plus"><i class="icofont-plus"></i>
                                </button>
                            </div>
                            <div class="view-add-group">
